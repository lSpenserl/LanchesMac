...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategoriaId,CategoriaName,Descricao")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategoriaId,CategoriaName,Descricao")] Categoria categoria)
        {
